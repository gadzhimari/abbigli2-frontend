...
export default class Login extends Component {
  ...
  render() {
	...
	L8.409,7.016L14,1.414z"/>
          ...
          <div className="popup-title">Сообщение пользователю было отправлено</div>
          <form className="popup-form">
            <div className="buttons-wrap">
              <button className="default-button" type="button" onClick={ ()=>{ dispatch(statusPopup(false)) } }>Ок</button>
            </div>
          </form>
        </div>
      </div>
