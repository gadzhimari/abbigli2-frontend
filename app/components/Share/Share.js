...
export default function Share(props) {
  ...
  return (
    <div className="share">
      <div className="share__icon"></div>
      <div className="dropdown-corner"></div>
      <div className="dropdown">
        <a
          className="social-btn facebook"
          href={`https://www.facebook.com/sharer.php?u=${location.origin}${props.postLink}/`}
          target="_blank"
        ...
        <a
          ...
          href={`https://www.pinterest.com/pin/create/button/?url=${location.origin}${props.postLink}/`}
          target="_blank"
          rel="noopener noreferrer"
        >
