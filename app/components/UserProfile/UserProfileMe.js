...
class UserProfileMe extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      okAcc: props.data.ok_account || '',
      vkAcc: props.data.vk_account || '',
  ...
  hideEdit = () => {
    ...
    this.setState({
      ...
      okAcc: data.ok_account || '',
      vkAcc: data.vk_account || '',
  ...
  upload = (e) => {
    ...
    return fetch(`${API_URL}my-profile/`, init)
      .then(res => res.json())
      .then((responseData) => {
  ...
  saveData = (e) => {
    ...
    const payload = {
      ...
      vk_account: this.state.vkAcc,
      ok_account: this.state.okAcc,
  ...
  render() {
	...
	C9.68,4,10.4,3.28,10.4,2.4V2.072c2.344,0.953,4,3.248,4,5.928C14.4,9.664,13.76,11.176,12.721,12.313z"/>
            ...
            <div className="user-profile__social-links">
              ...
              {
                location === 'en' && (this.state.edit || (pinterestAcc && pinterestAcc.length > 1))
                &&
                <div className="input-profile-social">
              ...
              {
                location === 'en' && (this.state.edit || (googleAcc && googleAcc.length > 1))
                &&
                <div className="input-profile-social">
              ...
              {
                location === 'ru' && (this.state.edit || (okAcc && okAcc.length > 1))
                &&
                <div className="input-profile-social">
                  <a
                  ...
                  <input
                    className="input-profile"
                    type="text"
                    placeholder="http://ok.ru/profile"
                    value={okAcc}
                    name="okAcc"
                    onChange={this.changeSociety}
                    disabled={!this.state.edit}
              ...
              {
                location === 'ru' && (this.state.edit || (vkAcc && vkAcc.length > 1))
                &&
                <div className="input-profile-social">
                  <a
                  ...
                  <input
                    className="input-profile"
                    type="text"
                    placeholder="http://vk.com/profile"
                    value={vkAcc}
                    onChange={this.changeSociety}
                    name="vkAcc"
                    disabled={!this.state.edit}
