    ...
    return (
      <div className="popup-wrap" id="password-reset-popup" style={{ display: 'block' }}>
          <div className="popup">
              ...
              onClick={ ()=>{ dispatch(resetPopup(false)) } }
            >
              ...
              <div className="buttons-social">
                  <a
                    ...
                    onClick={(e)=>(this._facebookLogin(e))}
                  >
...
<path d="M7.419,5.279L4.93,5.284V3.609c0,0-0.053-0.919,0.956-0.919c0-0.01,1.522,0,1.522,0V0.001H4.72
	...
	<path d="M7.034,5.998c-0.002,0.795,0,1.591,0.003,2.386c1.343,0.042,2.685,0.022,4.026,0.042
		...
		C21.479,5.994,20.809,5.994,20.139,5.988z"/>
                  ...
                  {/*<a
                    className="button-social vkontakte"
                    onClick={(e)=>(this._vkLogin(e))}
                  >
                    <div className="icon-wrap">
                      <svg className="icon">
              ...
              <form className="popup-form">
                  ...
                  <div className="buttons-wrap">
                    ...
                    <button
                      ...
                      type="button"
                      onClick={ ()=>{ dispatch(dispatch(resetPopup(false)), dispatch(registerPopup(true))) } }
                    >
                      {__t('Sign Up')}
                    </button>
                  </div>
