      ...
      <div className="popup-wrap" id="sendMessage">
        ...
        >
          ...
          <form className="register-popup__form">
            ...
            >
              {__t("We've sent an email with an confirmation code. Click the link in the email to confirm your registration.If you don't see the email, check other places it might be, like your junk, spam, or other folders.")}
            </p>
            <Button
              color="secondary"
