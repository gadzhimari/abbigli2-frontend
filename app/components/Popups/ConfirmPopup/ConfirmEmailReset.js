...
class ConfirmEmailReset extends ConfirmPopup {
  ...
  description = __t("We've sent an email with an confirmation code. Click the link in the email to reset your password.If you don't see the email in the general folders, check other places it might be, like your junk, spam, or other folders.")
