...
class ProfileFeed extends Component {
  static prerenderData = ({ store }, nextState, replace, callback) => {
    ...
    if (!state.Profile.data.is_feed_visible) {
      callback();
    }
  ...
  toggelePrivacy = () => {
    ...
    formData.append('is_feed_visible', !user.is_feed_visible);
    ...
    const contentTemplate = () => (<div>
      {
        ...
        <div className="profile__privacy">
          <a
            className="profile__privacy-link"
            onClick={this.toggelePrivacy}
          >
...
<path d="M23.96,9.122c-1.172-2.021-2.908-3.673-5.03-4.791l2.792-2.753c0.134-0.132,0.134-0.347,0-0.479
	...
	c1.415,0.491,2.904,0.74,4.424,0.74c4.689,0,9.006-2.421,11.266-6.318C24.273,10.336,24.273,9.664,23.96,9.122z"/>
      ...
      <div className="cards-wrap favorites legacy">
        ...
        {
          (user.is_feed_visible && isMe && !itemsPosts.length)
          &&
